...
void Display1() {
   glColor3f(0.2,0.15,0.88); // albastInru
...
void Display3() {
    printf("[i] Am accesat Display3()\n");
   // trasare puncte GL_POINTS : deseneaza n puncte
   glColor3f(1,0.1,0.1); // rosu
   glBegin(GL_POINTS);
        // de completat ...

        printf("[i] Desenez punct stanga sus\n");
        glVertex2f(-0.5, 0.5);

        printf("[i] Desenez punct stanga jos\n");
        glVertex2f(-0.5, -0.5);

        printf("[i] Desenez punct in dreapta sus\n");
        glVertex2f(0.5, 0.5);

        printf("[i] Desenez punct in dreapta jos\n");
        glVertex2f(0.5, -0.5);
...
void Display4() {
   ...
   glBegin(GL_LINE_STRIP);
        // de completat ...
        printf("[i] Desenez linie verticala in colt!\n");
        glVertex2f(1.0,0.8);
        glVertex2f(1.0,1.0);

        printf("[i] Desenez linie oblica din colt spre centru! \n");
        glVertex2f(1.0,0.8);
        glVertex2f(0.5,0.5);

        printf("[i] Desenez linie verticala ! \n");
        glVertex2f(0.5,0.5);
        glVertex2f(0.5,0.3);
...
int main(int argc, char** argv) {
   ...
   // Functii callback : functii definitŞe in program si
